  ...
  static Future<void> init() async {
    ...
    if (hasDartDefines) {
      ...
      try {
        ...
        debugPrint(
          "AppConfig: ⚠️ .env file load failed (expected in local dev): $e",
        );
        _dotenvLoadedFromFile = false;
      }
    } else {
      ...
      debugPrint(
        'AppConfig: CRITICAL - In release mode but DGC_BASE_URL or DGC_API_KEY not provided via dart-define.',
      );
      _dotenvLoadedFromFile = false;
    }
  }
